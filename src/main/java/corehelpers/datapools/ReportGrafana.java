...
public class ReportGrafana {
    ...
    private static String grafanaXml = ElementsFinder.TESTINPUTS + "grafana_settings.xml";
    ...
    public static void setGrafanaXml(String grafanaXml) {
        ReportGrafana.grafanaXml = DataReader.TESTINPUTS + grafanaXml;
    }
    ...
    private String makeTelegrafString() {
        ...
        final String grafanaString = properties.getProperty("measurement") + "," +
                "runID=" + System.getProperty("SELEF_TIMESTAMP") + "," +
