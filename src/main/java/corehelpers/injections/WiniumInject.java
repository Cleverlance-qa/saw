...
public class WiniumInject extends MethodHelperWinium {
     ...
     */
    public WiniumInject() {
        super(new <WiniumDriver>DataReader(new DriversSetUp().initWiniumInjection()));
    }
    ...
    public WiniumInject(String propertiesFile) {
        super(new <WiniumDriver>DataReader(new DriversSetUp().initWiniumInjection(propertiesFile)));
    }
    ...
    public WiniumInject(WebDriver driver) {
        super(new <WiniumDriver>DataReader(new DriversSetUp().initWiniumInjection(driver)));
    }
    ...
    public WiniumInject(String propertiesFile, WebDriver driver) {
        super(new <WiniumDriver>DataReader(new DriversSetUp().initWiniumInjection(propertiesFile, driver)));
    }
